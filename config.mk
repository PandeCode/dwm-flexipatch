...
CFLAGS   = -std=c99 -pedantic -Wall -Wno-unused-function -Wno-deprecated-declarations -Wno-tautological-pointer-compare -Wno-strict-prototypes -Wno-pointer-compare -Os ${INCS} ${CPPFLAGS}
LDFLAGS  = ${LIBS}

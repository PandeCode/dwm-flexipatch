...
CFLAGS   = -std=c99 -pedantic -Wall -Wno-unused-function -Wno-deprecated-declarations -Wno-tautological-pointer-compare -Wno-strict-prototypes -Wno-pointer-compare -O3 ${INCS} ${CPPFLAGS}
LDFLAGS  = ${LIBS}
